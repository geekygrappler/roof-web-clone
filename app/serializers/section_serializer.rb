class SectionSerializer < ActiveModel::Serializer
    attributes :id, :name, :notes, :line_items, :building_materials, :total_cost, :total_cost_line_items, :total_cost_supplied_materials, :total_cost_supplied_by_pro_materials
