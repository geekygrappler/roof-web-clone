...
import '../projects/_tender_summary.tag'
import '../projects/_project_payments.tag'
...
<r-admin-project-form-tender>
  ...
  <p if="{hasNothing()}">
    ...
    <div if="{hasNothing()}" class="mt2">
      <a class="btn btn-primary" href="/app/admin/projects/{record.id}/tenders/new">Create a Tender Document</a>
    </div>
  </p>

  <ul class="list-reset mxn1">

    <li if="{record.tender}" class="block p1 sm-col-12 align-top">
      <div class="px2 border">
        <h2 class="inline-block">{ formatCurrency(record.tender.total_amount) }</h2>
        <span class="inline-block align-middle h6 mb1 px1 border pill right mt2">Tender</span>

        <div class="m0 mxn2">
        <r-tender-summary document="{record.tender.document}"></r-tender-summary>
        </div>

        <p class="overflow-hidden m0 mxn2 p1 border-top">
          <a class="btn btn-small" href="/app/projects/{opts.id}/tenders/{record.tender.id}">Open</a>
  ...
  <script>
  this.hasNothing = () => _.isEmpty(this.record.tender)
  this.mixin('adminForm')
  </script>
</r-admin-project-form-tender>
...
<r-admin-project-form-quotes>
  ...
  <div if="{_.isEmpty(this.quotes)}" class="mt2">
    <a class="btn btn-primary mb2" href="/app/admin/projects/{record.id}/quotes/new">Create a Quote</a>
  </div>
  ...
  this.updateRecord = (record) => {
    ...
    opts.api.quotes.index({project_id: this.record.id})
  }
...
<r-admin-project-form>
  ...
  this.subnavLinks = [
    ...
    {href: `/app/admin/projects/${opts.id}/edit/tender`, name: 'tender', tag: 'r-admin-project-form-tender'},
