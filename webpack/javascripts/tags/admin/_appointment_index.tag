      ...
      <table id="streamtable" class="table-light bg-white">
        ...
        <tbody>
          <tr each="{ record, i in records }">
            ...
            <td>
              <a href="/app/admin/{record.host_type.plural().toLowerCase()}/{record.host_id}/edit" >{record.host_id}</a>
            </td>
            <td>
              <a href="/app/admin/{record.host_type.plural().toLowerCase()}/{record.host_id}/edit" >{record.host_type}</a>
            </td>

            <td>
              <a href="/app/admin/{record.attendant_type.plural().toLowerCase()}/{record.host_id}/edit" >{record.attendant_id}</a>
            </td>
            <td>
              <a href="/app/admin/{record.attendant_type.plural().toLowerCase()}/{record.host_id}/edit" >{record.attendant_type}</a>
            </td>
